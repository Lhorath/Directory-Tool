...
<head>
    ...
    <title>Project Test Bench</title>
    ...
    <style>
        /* Apply the futuristic font family */
        body {
            font-family: 'Exo 2', sans-serif;
            --primary-red: #ff003c;
            --dark-bg: #0a0a0a; /* Slightly less harsh than pure black */
        }
...
<body class="futuristic-bg text-gray-200 flex flex-col min-h-screen">

    <div class="container mx-auto px-4 py-12 md:py-16 flex-grow">

        <!-- Header Section -->
        <div class="text-center mb-16">
            <h1 class="text-4xl md:text-5xl font-bold text-white uppercase tracking-wider" style="text-shadow: 0 0 8px var(--primary-red);">Project Hub</h1>
            ...
            <div class="bg-gray-900/60 backdrop-blur-md rounded-lg overflow-hidden flex flex-col card-glow">
                <div class="p-6 flex-grow flex flex-col">
                    ...
                    <div class="flex justify-between items-start mb-4">
                        ...
                        <div class="text-2xl" style="color: var(--primary-red);">
